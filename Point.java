...
public class Point{
    ...
    static void nhap_vao_3_diem(Point thu1,Point thu2, Point thu3){
        ...
        System.out.print("Nhap toa do x thu 1:");
        thu1.setX(sc.nextDouble());
        System.out.print("Nhap toa do y thu 1:");
        thu1.setY(sc.nextDouble());
        
        System.out.print("Nhap toa do x thu 2:");
        thu2.setX(sc.nextDouble());
        System.out.print("Nhap toa do y thu 2:");
        thu2.setY(sc.nextDouble());
        
        System.out.print("Nhap toa do x thu 3:");
        thu3.setX(sc.nextDouble());
        System.out.print("Nhap toa do y thu 3:");
